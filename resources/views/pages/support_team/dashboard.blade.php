...
@section('content')
               ...
               <div class="card card-body bg-blue-400 has-bg-image">
                   <div class="media">
                       <div class="media-body">
                           ...
                           <span class="text-uppercase font-size-xs font-weight-bold">Total Pelajar</span>
                       </div>
               ...
               <div class="card card-body bg-indigo-400 has-bg-image">
                   <div class="media">
                       ...
                       <div class="media-body text-right">
                           ...
                           <span class="text-uppercase font-size-xs">Total Orang Tua Murid</span>
                       </div>
                   </div>
               </div>
           </div>
    ...
    <div class="card">
        <div class="card-header header-elements-inline">
            <h5 class="card-title">Kalender Event Sekolah</h5>
         {!! Qs::getPanelOptions() !!}
        </div>
